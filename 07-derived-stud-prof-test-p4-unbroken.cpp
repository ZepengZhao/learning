...
int main(){
   ...
   // Because id_card is now a member of UCLA_Person 
   // pointers have access to this member function.
   // Moreover, they know which particular member to call. 
   cout << p_stud->id_card() << "\n";
   cout << p_prof->id_card() << "\n";
   cout << p_pers->id_card() << "\n";
...
/** 
    Note: When is the decision (which member to call?) being
          made? ( compile vs running )
*/
